...
<body>
    ...
    <section id="service-details">
        ...
        <div class="small-img-col" onclick="changeImage('<?= ROOT ?>/assets/img/services/7790133.jpg')">
            <img src="<?= ROOT ?>/assets/img/services/7790133.jpg" width="100%" class="small-img" alt="">
        </div>
        <div class="small-img-col" onclick="changeImage('<?= ROOT ?>/assets/img/services/photo1.jpg')">
            <img src="<?= ROOT ?>/assets/img/services/photo1.jpg" width="100%" class="small-img" alt="">
        </div>
        <div class="small-img-col" onclick="changeImage('<?= ROOT ?>/assets/img/services/photo2.jpg')">
            <img src="<?= ROOT ?>/assets/img/services/photo2.jpg" width="100%" class="small-img" alt="">
        </div>
        <div class="small-img-col" onclick="changeImage('<?= ROOT ?>/assets/img/services/photo1.jpg')">
            <img src="<?= ROOT ?>/assets/img/services/photo1.jpg" width="100%" class="small-img" alt="">
        </div>
