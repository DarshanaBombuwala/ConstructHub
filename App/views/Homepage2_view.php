...
<body>
    ...
    <section id="Home">
        ...
        <div class="mainnav">
            ...
            <div id="search-popup">
                <input type="search" id="search-input-res" placeholder="Search here..." />
                <button id="search"><i class="fa-solid fa-magnifying-glass"></i></button>
                <button id="close-btn"><i class="fa-solid fa-times"></i></button>
            </div>
    ...
    <!--About-->
    <div class="blankspace" id="About"></br></div>
    <div class="about" id="About_">
    ...
    <button id="feedback">Feedback Form</button>
