...
<body>
    ...
    if (isset($_SESSION['new_user'])) {
        ...
        $welcomeMessage = "Welcome, " . $newUser . "! Thank you for registering.";
        // Unset the new user session variable
        unset($_SESSION['new_user']);
    } 
    
    if (isset($_SESSION['USER_WELCOME'])) {
        $welcomeMessage1 = "Welcome Back " . Auth::getFirstname() . "!";
        unset($_SESSION['USER_WELCOME']);
    }

    $flag = false;

    if (isset($welcomeMessage) && !$flag) {
        echo '<div id="welcomePopup" class="popup">';
        echo '    <span class="close" onclick="closePopup()">&times;</span>';
        echo '    <p>' . $welcomeMessage . '</p>';
        echo '</div>';
        $flag = true;
    } elseif (isset($welcomeMessage1) && !$flag) {
        echo '<div id="welcomePopup" class="popup">';
        echo '    <span class="close" onclick="closePopup()">&times;</span>';
        echo '    <p>' . $welcomeMessage1 . '</p>';
        echo '</div>';
        $flag = true;
    }
